...
export default function SuccessPage() {
  ...
  return (
    <>
    <div className="min-h-screen md:mr-4 md:ml-4 rounded-2xl md:mb-2 bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center px-4">
      <div className="bg-white/80 backdrop-blur-sm shadow-2xl rounded-3xl p-8 max-w-md w-full text-center border border-white/20">
        ...
        <div className="bg-gray-50/70 rounded-xl p-5 mb-6 text-left space-y-3">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="font-mono text-xs text-gray-600">{txnid || "Processing"}</span>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-400 mt-6">
          Need help? Contact us at <span className="font-semibold text-blue-800 cursor-pointer">contact@mictale.in</span>
        </p>
      </div>
    </div>
    <Footer />
