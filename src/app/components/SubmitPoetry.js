        ...
        <div className="bg-gradient-to-br from-gray-800/70 via-gray-900/80 to-black/90 backdrop-blur-md rounded-2xl p-8 md:p-10 shadow-xl border border-gray-600/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center">
              <button className="cursor-pointer group relative px-8 md:px-10 py-3 md:py-4 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 text-gray-900 font-semibold rounded-xl shadow-lg transform transition-all duration-200 hover:scale-[1.02] hover:shadow-xl active:scale-[0.98] overflow-hidden">
