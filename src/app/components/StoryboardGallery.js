      ...
      <div className="bg-gray-800/40 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden shadow-lg">
        ...
        {currentImage && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="relative bg-gray-900/60 backdrop-blur-xl border border-white/10 h-fit rounded-2xl max-w-4xl w-full flex flex-col md:flex-row shadow-2xl">
              ...
              <div className="w-full md:w-3/4 relative">
                <img 
                  ...
                  className="w-full h-[500px] object-cover rounded-t-2xl md:rounded-l-2xl md:rounded-tr-none"
                />
                <button 
              ...
              <div className="w-full md:w-1/4 p-6 text-white flex flex-col justify-center">
