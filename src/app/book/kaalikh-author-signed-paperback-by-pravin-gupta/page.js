...
export const metadata = {
  ...
  description: `Kaalikh by Pravin Gupta — a Hindi-Urdu poetry collection. Buy the author-signed revised edition online.`,
  alternates: { canonical: 'https://www.mictale.in/book/kaalikh-author-signed-paperback' },
  openGraph: {
    title: 'Kaalikh (Author-signed, Revised Edition) | MicTale',
    description: 'Kaalikh by Pravin Gupta — a Hindi-Urdu poetry collection. Buy the author-signed revised edition online.',
    url: 'https://www.mictale.in/book/kaalikh-author-signed-paperback',
    images: ['https://firebasestorage.googleapis.com/v0/b/cord-60823.appspot.com/o/Open%20Kaalikh%20Graph.png?alt=media'],
    type: 'book'
  },
  twitter: {
...
"कालिख" एक हिंदी-उर्दू काव्य संग्रह है, जिसमें नज़्म, ख्याल, ग़ज़ल और शेर शामिल हैं। यह पुस्तक प्रेम, दुःख, और जीवन की जटिलताओं के विषयों को गहराई से छूती है।`,
  inStock: true,
  bookimage: 'https://firebasestorage.googleapis.com/v0/b/cord-60823.appspot.com/o/Open%20Kaalikh%20Graph.png?alt=media',
  stockCount: 23
}

export default function KaalikhPage() {
  const canonical = 'https://www.mictale.in/book/kaalikh-author-signed-paperback-by-pravin-gupta'
  ...
  return (
    <>
      {/* server-rendered JSON-LD that crawlers can see */}
      <script
